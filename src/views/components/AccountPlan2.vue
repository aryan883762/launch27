                ...
                <el-row :gutter="20" class="account-plans2" v-loading="loading" style="max-width: 1000px; margin: 0 auto;">
                        ...
                        <el-row :gutter="20">
                            <el-col :key="plan.name" :md="6" :sm="6" :class="plan.plan_id" :xs="24" v-for="plan in available_plans">
                                <el-card :class="getCardClass(plan)" shadow="always">
                                    ...
                                    <div class="text-center plan-price"> <i>{{ company_currency }}</i> <span>{{ subscription.recurring === "monthly" ? plan.amount : getAnnualAmount(plan) }}</span> <span>{{ subscription.recurring === "monthly" ? '/Mo' : '/Yr' }}</span></div>
                                    ...
                                    <div class="button-place">
                                        <el-button type="primary" size="small" :class="subscription.plan_id === plan.plan_id ? plan.id + 'chosen' : plan.id " :disabled="subscription.plan_id === plan.plan_id || true"
                                                   @click="changeSubscription(plan.id)">{{ subscription.plan_id === plan.plan_id ? "Current Plan" : "Get Started" }}
                                        </el-button>
                                    </div>
                                    <p v-if="plan.plan_id !== 'enterprise'" style="color: #012232; font-style: italic; font-size: 10px; position: absolute; bottom: 0">Each additional booking is .99 cents</p>
                                </el-card>
                            </el-col>
                        </el-row>
                    </el-col>
                    ...
                    <el-col :md="24" :sm="24" class="tnc-area">
                        ...
                        <div class="tnc">
                            ...
                            <p>By clicking "Start your free trial," as an individual or as an authorized representative of client, you as client or client which you represent (“you”), agree to be bound by all terms and conditions of this Services Agreement (“Agreement”), including, without limitation, all documents, policies, and procedures incorporated herein by reference. This Agreement is a binding contract between Launch 27 Software, LLC (“Launch 27” or “we”) and you and/or the company or other legal entity that you represent (collectively, “you”) for the use of Launch 27’s services (“Services”). Launch 27 and you are referred to individually as a “party” and collectively as the “parties”. If you are entering into this Agreement as an individual, you represent and warrant that you are over the age of eighteen (18) and possess the legal capacity to bind yourself to its terms and conditions. If you are entering into this Agreement on behalf of a business organization or entity, you represent and warrant that you are duly authorized to bind that entity to this Agreement.</p>

                            <p class="tnc-header">Services.</p>
                            <p>All Services made available to you under this Agreement, including any related support services or documentation we may provide, are collectively referred to in this Agreement as the “Services”. We reserve the right to modify the Services at any time and without advance notice. At no time, and under no circumstances, does this Agreement represent a sale or license of the intellectual property contained within the Services or any software version of Launch 27 (including any copy or update of the same).</p>
                            ...
                            <p>Some portions of the Service are billed on a subscription basis (“Subscription(s)”). You will be billed in advance on a recurring and periodic basis (“Billing Cycle”). Billing cycles are set either on a monthly or annual basis, depending on the type of subscription plan which you select.  At the end of each Billing Cycle, your Subscription will automatically renew under the same conditions unless you or Launch 27 cancel the Subscription. You may cancel your Subscription renewal by contacting Launch 27 customer support team.</p>

                            <p>A valid payment method, including credit card, is required to process the payment for your Subscription. You must provide Launch 27 with accurate and complete billing information, including full name, address, state, zip code, telephone number, and  valid payment method information. By submitting such payment information, you authorize Launch 27 to charge all Subscription fees incurred through your account to any such payment instruments.</p>
                            ...
                            <p>If you do enter your billing information when signing up for the Free Trial, you will not be charged by Launch 27 until the Free Trial has expired, or until your Free Trial has been ended early at your discretion. On the last day of the Free Trial period, unless you cancelled your Subscription, you will be automatically charged the applicable Subscription fees for the type of Subscription you have selected.</p>
                            ...
                            <p>By posting Content on or through the Service, you represent and warrant that: (i) the Content is yours (you own it) and/or you have the right to use it and the right to grant us the rights and license as provided in these Terms, and (ii) that the posting of your Content on or through the Service does not violate the privacy rights, publicity rights, copyrights, contract rights or any other rights of any person or entity. We reserve the right to terminate the Account of anyone found to be infringing intellectual property rights.</p>
                            ...
                            <p>You are responsible for maintaining the confidentiality of your Account and password, including but not limited to the restriction of access to your Account. You agree to accept responsibility for any and all activities or actions that occur pursuant to your Account and/or password. You must notify us immediately upon becoming aware of any breach of security or unauthorized use of your Account.</p>
                            ...
                            <p>Neither we nor any of our employees, agents, representatives, assigns or service suppliers will be liable for unauthorized access (i.e., hacking) into our servers or your transmission facilities, premises or equipment, or for unauthorized access to data files, programs, procedures or information thereon, unless and only to the extent that this disclaimer is prohibited by applicable law.</p>

                            <p class="tnc-header">Exclusions</p>
                            <p>Some jurisdictions do not allow the exclusion of certain warranties or the exclusion or limitation of liability for consequential or incidental damages, so the limitations above may not apply to you.</p>

                            <p class="tnc-header">Governing Law</p>
                            <p>This Agreement shall be governed by and construed in accordance with the laws of the State of Delaware, without giving effect to applicable principles of conflicts of law to the extent that the application of the laws of another jurisdiction would be required thereby. In case of any dispute related to this Agreement, the parties agree to submit to personal jurisdiction in the State of Delaware.  Furthermore, the parties hereby irrevocably and unconditionally submit to the exclusive jurisdiction of any court of the State of Delaware or any federal court sitting in the State of Delaware for purposes of any suit, action or other proceeding arising out of this Agreement.  THE PARTIES HEREBY IRREVOCABLY WAIVE ANY AND ALL RIGHTS TO A TRIAL BY JURY IN ANY ACTION, SUIT OR OTHER PROCEEDING ARISING OUT OF OR RELATING TO THE TERMS, OBLIGATIONS AND/OR PERFORMANCE OF THIS AGREEMENT.</p>
                            ...
                            <p>Each party agrees and undertakes that during the term of this Agreement and thereafter in perpetuity it will keep confidential and will not use for its own purposes nor without the prior written consent of the other party disclose to any third party any information of a confidential nature (including without limitation trade secrets and information of commercial value) which may become known to that party from the other party ("Confidential Information") unless the information (i) is public know ledge or (ii) is already known to that party at the time of disclosure or (iii) subsequently becomes public knowledge other than by breach of this Agreement or (iv) subsequently comes lawfully into the possession of that party from a third party or (v) is required to be disclosed by law or court order provided that the recipient promptly notifies the discloser in writing of the requirement for disclosure and limits the content and distribution of such disclosure to the extent reasonably possible.</p>

                            <p class="tnc-header">Assignment</p>

                            <p>You may not assign this Agreement or resell the right to use the Services without our prior written consent. We may assign or subcontract this Agreement at any time. This Agreement will be binding upon and inure to the benefit of all of our successors and assigns, which will be bound by all of the obligations of their predecessors or assignors.</p>
                            ...
                            <p>Launch 27 will not be liable for any delay or failure to perform any obligation under this Agreement where the delay or failure results from any cause beyond Launch 27’s reasonable control, including acts of God, labor disputes or other industrial disturbances, systemic electrical, telecommunications, or other utility failures, earthquake, storms or other elements of nature, blockages, embargoes, riots, acts or orders of government, acts of terrorism, or war.</p>
                    ...
                    <el-col :md="24" :sm="24" class="tnc-footer-area">
                        <p class="text-center">Scale up plan cost</p>
                        <p class="text-center">Lifetime discount cost</p>
                        <p class="text-center" style="font-weight: bold">Onetime loyalty discount - </p>

                        <p class="text-center" style="color: #1fb6ff;font-size: 25px;font-weight: bold">Total charged today - $0</p>
                        ...
                        <p class="text-center"><el-checkbox v-model="tnc_agreed">I agree to Launch27's terms and conditions</el-checkbox></p>

                        <div v-if="false" class="flex-row-center bottom-line">
