        ...
        <el-row v-if="personDetails">
            <el-col :md="24" class="customer-box content-box">
                <el-row class="customer-content-top-left-wrap">
                    <el-avatar :size="42" :src="personDetails.avatar" class="customer-content-top-icon" v-if="personDetails.avatar"/>
                    <avatar :size="42" :username="personDetails.fullname" class="pull-left profile-avatar" color="white" v-if="!personDetails.avatar"/>
                    ...
                    <el-dropdown size="medium" type="primary">
                          <span class="el-dropdown-link">
                            <i class="el-icon-more" style="font-size: 20px; position:relative; right :-10px; cursor:pointer;"/>
                          </span>
                ...
                <el-row v-if="false">
                    <el-col :md="24" class="customer-button-wrap">
                        <el-button @click="$router.push({ name: 'dashboard_booking_new', query:{account_id : personDetails.id} })" class="customer-appointment-btn" round size="small" v-if="personDetails.role === 'r_customer'">
                            Book an Appointment
                        </el-button>
                    </el-col>
                </el-row>
            </el-col>
            <el-col :md="24" v-if="personDetails.role === 'r_team'" class="address-box content-box" style="    min-height: auto;">
            ...
            <el-col :md="24" class="credit-card-box content-box" v-if="personDetails.role == 'r_customer' && cardPaymentsEnabled">
                <el-row>
                    <el-col class="credit-card-box-title" style="margin-bottom: 10px;">
                        <span>Credit Cards on file</span>
                    </el-col>
                </el-row>
                <account-cards :account="personDetails" :add-button="true" :mini="true" v-model="selected_card"></account-cards>

            </el-col>
            <el-col :md="24" class="tags-box content-box" v-if="personDetails.special_tax && personDetails.special_tax.active">
                <el-row>
            ...
            <span>
              Additional Emails
                ...
                <el-row v-loading="loading_email">
                    ...
                    <el-col>
                        <el-button @click="showInput" class="button-new-tag" size="mini" style="padding: 5px;" type="primary" v-if="!emailInputVisible">+ Add Email</el-button>
                    </el-col>
                </el-row>
            ...
            <span>
              3 Day Email
                    ...
                    <el-col :md="12" :sm="12" :xs="24" class="notification-switch-wrap">
                        <el-switch @change="updatePerson()" active-color="#4bd865" active-text="On" class="notification-switch" inactive-color="#d9dadc" inactive-text="Off" v-model="personDetails['3days_email']"/>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :md="12" :sm="12" :xs="24" class="notification-title">
            <span>
              5 Day Email
                    ...
                    <el-col :md="12" :sm="12" :xs="24" class="notification-switch-wrap">
                        <el-switch @change="updatePerson()" active-color="#4bd865" active-text="On" class="notification-switch" inactive-color="#d9dadc" inactive-text="Off" v-model="personDetails['5days_email']"/>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :md="12" :sm="12" :xs="24" class="notification-title">
            <span>
              Feedback Email
                    ...
                    <el-col :md="12" :sm="12" :xs="24" class="notification-switch-wrap">
                        <el-switch @change="updatePerson()" active-color="#4bd865" active-text="On" class="notification-switch" inactive-color="#d9dadc" inactive-text="Off" v-model="personDetails['feedback_email']"/>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :md="12" :sm="12" :xs="24" class="notification-title">
            <span>
              SMS Message
                    ...
                    <el-col :md="12" :sm="12" :xs="24" class="notification-switch-wrap">
                        <el-switch @change="updatePerson()" active-color="#4bd865" active-text="On" class="notification-switch" inactive-color="#d9dadc" inactive-text="Off" v-model="personDetails['sms_notification']"/>
                    </el-col>
                </el-row>
            </el-col>
        </el-row>
