...
<template>
  <div id="changeContab">
    <el-button class="language" type="text" @click="i18n = i18n === 'en' ? 'cn' : 'en'">
      {{ i18n }}
    </el-button>
        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio v-model="second.cronEvery" label="2">
              ...
              <el-input-number size="small" v-model="second.incrementIncrement" :min="1" :max="60" />
              {{ text.Seconds.interval[1] || "" }}
              <el-input-number size="small" v-model="second.incrementStart" :min="0" :max="59" />
          ...
          <el-row>
            <el-radio v-model="second.cronEvery" label="4">
              ...
              <el-input-number size="small" v-model="second.rangeStart" :min="1" :max="60" />
              {{ text.Seconds.cycle[1] || "" }}
              <el-input-number size="small" v-model="second.rangeEnd" :min="0" :max="59" />
        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio v-model="minute.cronEvery" label="2">
              ...
              <el-input-number size="small" v-model="minute.incrementIncrement" :min="1" :max="60" />
              {{ text.Minutes.interval[1] }}
              <el-input-number size="small" v-model="minute.incrementStart" :min="0" :max="59" />
          ...
          <el-row>
            <el-radio v-model="minute.cronEvery" label="4">
              ...
              <el-input-number size="small" v-model="minute.rangeStart" :min="1" :max="60" />
              {{ text.Minutes.cycle[1] }}
              <el-input-number size="small" v-model="minute.rangeEnd" :min="0" :max="59" />
        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio v-model="hour.cronEvery" label="2">
              ...
              <el-input-number size="small" v-model="hour.incrementIncrement" :min="0" :max="23" />
              {{ text.Hours.interval[1] }}
              <el-input-number size="small" v-model="hour.incrementStart" :min="0" :max="23" />
          ...
          <el-row>
            <el-radio v-model="hour.cronEvery" label="4">
              {{ text.Hours.cycle[0] }}
              <el-input-number size="small" v-model="hour.rangeStart" :min="0" :max="23" />
              {{ text.Hours.cycle[1] }}
              <el-input-number size="small" v-model="hour.rangeEnd" :min="0" :max="23" />
              {{ text.Hours.cycle[2] }}
            </el-radio>
          </el-row>
        </div>
        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio v-model="day.cronEvery" label="2">
              ...
              <el-input-number size="small" v-model="week.incrementIncrement" :min="1" :max="7" />
          ...
          <el-row>
            <el-radio v-model="day.cronEvery" label="3">
              ...
              <el-input-number size="small" v-model="day.incrementIncrement" :min="1" :max="31" />
              {{ text.Day.intervalDay[1] }}
              <el-input-number size="small" v-model="day.incrementStart" :min="1" :max="31" />
          ...
          <el-row>
            <el-radio class="long" v-model="day.cronEvery" label="4">
              ...
              <el-select size="small" multiple v-model="week.specificSpecific">
                <el-option v-for="val in 7" :key="val" :label="text.Week[val - 1]" :value="['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'][val - 1]" />
              </el-select>
            </el-radio>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-radio v-model="day.cronEvery" label="9">
              <el-input-number size="small" v-model="day.cronDaysBeforeEomMinus" :min="1" :max="31" />
          ...
          <el-row>
            <el-radio v-model="day.cronEvery" label="10">
              ...
              <el-input-number size="small" v-model="day.cronDaysNearestWeekday" :min="1" :max="31" />
          ...
          <el-row>
            <el-radio v-model="day.cronEvery" label="11">
              ...
              <el-input-number size="small" v-model="week.cronNthDayNth" :min="1" :max="5" />
        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio v-model="month.cronEvery" label="2">
              ...
              <el-input-number size="small" v-model="month.incrementIncrement" :min="0" :max="12" />
              {{ text.Month.interval[1] }}
              <el-input-number size="small" v-model="month.incrementStart" :min="0" :max="12" />
            </el-radio>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-radio v-model="month.cronEvery" label="4">
              {{ text.Month.cycle[0] }}
              <el-input-number size="small" v-model="month.rangeStart" :min="1" :max="12" />
              {{ text.Month.cycle[1] }}
        ...
        <div class="tabBody">
          ...
          <el-row>
            <el-radio v-model="year.cronEvery" label="2">
              ...
              <el-input-number size="small" v-model="year.incrementIncrement" :min="1" :max="99" />
              {{ text.Year.interval[1] }}
              <el-input-number size="small" v-model="year.incrementStart" :min="2018" :max="2118" />
            </el-radio>
          </el-row>
          <el-row>
            <el-radio class="long" v-model="year.cronEvery" label="3">
              ...
              <el-select size="small" filterable multiple v-model="year.specificSpecific">
                <el-option v-for="val in 100" :key="val" :label="2017 + val" :value="2017 + val" />
              </el-select>
            </el-radio>
          </el-row>
          <el-row>
            <el-radio v-model="year.cronEvery" label="4">
              {{ text.Year.cycle[0] }}
              <el-input-number size="small" v-model="year.rangeStart" :min="2018" :max="2118" />
              {{ text.Year.cycle[1] }}
              <el-input-number size="small" v-model="year.rangeEnd" :min="2018" :max="2118" />
            </el-radio>
          </el-row>
        </div>
      </el-tab-pane>
